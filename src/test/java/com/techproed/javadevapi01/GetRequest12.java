...
public class GetRequest12 extends TestBaseDummyRestApi {
	...
	*/
	...
	public void get01() {
		...
		Employees actualData = response.as(Employees.class);//This code will convert the Response Body to Java Object
		...
		System.out.println("jsonFromActualData-> "+jsonFromActualData);
